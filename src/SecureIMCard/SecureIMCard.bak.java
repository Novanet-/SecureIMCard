...
//	private static final byte  INS_RESET                   = (byte) 0x38;
...
//
//
//	private void doReset(final APDU apdu, final short len)
//	{
//		try
//		{
//			//Create a transient byte array to store the temporary data
...
//
//	/**
//	 * @param apdu - Command APDU <br>
//	 *             &nbsp;&nbsp; INS: 0x37 <br>
//	 *             &nbsp;&nbsp; CDATA: message to be encrypted/decrypted <br>
//	 *             &nbsp;&nbsp; P1: 0 = 1024 bit, 1 = 2048 bit <br>
//	 *             &nbsp;&nbsp; P2: 0 = RSA, 1 = RSA_CRT <br>
//	 * @param len
//	 */
...
//					short outlen = 0;
//					outlen = rsaCipher.doFinal(buffer, ISO7816.OFFSET_CDATA, len, buffer, (short) 0);
...
//		if ((short) (loadedLen + len) > (short) rsaPubKey.length)
//		{
//			Util.arrayFillNonAtomic(flags, (short) 0, (short) flags.length, (byte) 0);
...
//			if ((short) loadedLen < (short) (modLen + 3) || (short) loadedLen > (short) (modLen + 32))
//			{
//				ISOException.throwIt(ISO7816.SW_WRONG_DATA);
//			}
//
...
//		}
//		short loadedLen = Util.getShort(flags, OFF_LEN);
//		if ((short) (loadedLen + len) > (short) rsaPriKey.length)
//		{
//			Util.arrayFillNonAtomic(flags, (short) 0, (short) flags.length, (byte) 0);
//			ISOException.throwIt(ISO7816.SW_WRONG_DATA);
//		}
...
//
//			final short i = (short) ((short) (modLen / (short) 2) * (short) 5);
//			final short j = (short) (modLen * (short) 2);
//
//			if (isCRT && (loadedLen != i) || (!isCRT && (loadedLen != j)))
//			{
//				ISOException.throwIt(ISO7816.SW_WRONG_DATA);
//			}
//
...
//	 * @param apdu - Command APDU <br>
//	 *             &nbsp;&nbsp; INS: 0x30 <br>
//	 *             &nbsp;&nbsp; CDATA: custom exponent value <br>
//	 *             &nbsp;&nbsp; P1: 0 = 1024 bit, 1 = 2048 bit <br>
//	 *             &nbsp;&nbsp; P2: 0 = RSA, 1 = RSA_CRT <br>
...
//			short keyLen;
//			byte alg;
//			RSAPublicKey tempPubKey;
//			RSAPrivateKey tempPrivKey;
//			KeyPair keyPair;
//
//			keyLen = buffer[ISO7816.OFFSET_P1] == 0 ? (short) 1024 : (short) 2048;
//			alg = buffer[ISO7816.OFFSET_P2] == 0 ? KeyPair.ALG_RSA : KeyPair.ALG_RSA_CRT;
//
//
//			alg = KeyPair.ALG_RSA_CRT;
//			keyLen = (short) 2048;
//
//
//			//			alg = KeyPair.ALG_RSA;
...
//
//			 keyPair = new KeyPair(alg, keyLen);
//			//			tempPubKey = (RSAPublicKey) KeyBuilder.buildKey(KeyBuilder.TYPE_RSA_PUBLIC, KeyBuilder.LENGTH_RSA_512, true);
//			//			tempPrivKey = (RSAPrivateKey) KeyBuilder.buildKey(KeyBuilder.TYPE_RSA_PRIVATE, KeyBuilder.LENGTH_RSA_512, true);
//			////			keyPair = new KeyPair(tempPubKey, tempPrivKey);
//			//
//			if (len > 32)
//			{
//				ISOException.throwIt(ISO7816.SW_WRONG_LENGTH);
